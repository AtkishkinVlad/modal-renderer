...
test.describe('Confirm Modal Stories', () => {
  ...
  test('should test confirmation cancellation', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDefaultStory();
  ...
  test('should test keyboard navigation in confirm modal', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDefaultStory();
  ...
  test('should test confirmation with different types', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDefaultStory();
  ...
  test('should test danger confirmation styling', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDangerOnlyStory();
  ...
  test('should test confirmation message content', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDefaultStory();
    ...
    await confirmModalPage.expectTextToBeVisible(
  ...
  test('should test confirmation accessibility', async ({
    confirmModalPage,
  }) => {
    await confirmModalPage.navigateToDefaultStory();
