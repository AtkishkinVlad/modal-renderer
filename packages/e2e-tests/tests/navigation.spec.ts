...
test.describe('Storybook Navigation and Integration', () => {
  ...
  test('should test storybook URL parameters', async ({ basePage }) => {
    ...
    await basePage.page.goto('/iframe.html?id=modal-renderer-simple-modal--default&viewMode=story&args={}');
  ...
  test('should test storybook iframe isolation', async ({ basePage }) => {
    ...
    const isInIframe = await basePage.page.evaluate(() => window !== window.top);
  ...
  test('should test storybook story switching', async ({ 
    ...
    const stories = [
      ...
      { page: confirmModalPage, story: 'modal-renderer-confirm-modal--default' }
    ];
